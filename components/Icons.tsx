...
export type IconName =
  ...
  | 'circle-info' | 'circle-alert' | 'circle-check'
...
const G: Record<IconName, El[]> = {
  ...
  sync: [['pl', '23 4 23 10 17 10'], ['p', 'M20.49 15a9 9 0 1 1-2.12-9.36L23 10']],
  ...
  'circle-info': [['p', 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zM12 8h.01M11 12h1v4h1']],
  'circle-alert': [['p', 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zM12 8v5M12 16h.01']],
  'circle-check': [['p', 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zM8 12l2.5 2.5L16 9']],
