...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 13, fontFamily: fonts.sansBold, color: colors.ink, marginBottom: 6, marginTop: 14 },
  input: {
    backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.cardBorder, borderRadius: radius.tile, padding: 13,
    fontSize: 15, color: colors.ink, fontFamily: fonts.sans,
  },
  dateText: { fontSize: 15, color: colors.ink, fontFamily: fonts.sans },
  chips: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: 8 },
  chip: { paddingVertical: 5, paddingHorizontal: 11, borderRadius: 16, backgroundColor: colors.blush },
  chipText: { fontSize: 12, color: colors.deepRose, fontFamily: fonts.sans },
  ...
  freqText: { fontSize: 12, color: '#666', fontFamily: fonts.sans },
  freqTextOn: { color: colors.deepRose, fontFamily: fonts.sansBold },
  timeRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 },
  timeBtn: {
    flex: 1, flexDirection: 'row', alignItems: 'center', gap: 8,
    backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.cardBorder, borderRadius: radius.tile, padding: 13,
  },
  timeText: { fontSize: 15, color: colors.ink, fontFamily: fonts.sans },
  removeTime: { padding: 4 },
  addTime: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 2 },
  addTimeText: { fontSize: 13, color: colors.primary, fontFamily: fonts.sansMed },
  note: { fontSize: 11, color: colors.faint, marginTop: 16, lineHeight: 16, fontFamily: fonts.sans },
  saveBtn: { backgroundColor: colors.primary, borderRadius: radius.button, padding: 16, alignItems: 'center', marginTop: 16 },
  saveText: { color: '#FFF', fontSize: 16, fontFamily: fonts.sansBold },
  removeBtn: { padding: 16, alignItems: 'center', marginTop: 4 },
  removeText: { color: '#C0504A', fontSize: 14, fontFamily: fonts.sansBold },
});