...
const styles = StyleSheet.create({
  ...
  muted: { color: colors.muted, fontFamily: fonts.sans },
  infoCard: { ...cardStyle, padding: 16, marginBottom: 20 },
  infoRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 5 },
  infoLabel: { fontSize: 13, color: colors.muted, fontFamily: fonts.sans },
  infoValue: { fontSize: 13, color: colors.ink, fontFamily: fonts.sansMed, flex: 1, textAlign: 'right' },
  ...
  monthTitle: { fontSize: 16, fontFamily: fonts.sansBold, color: colors.ink },
  weekdays: { flexDirection: 'row', marginBottom: 6 },
  weekday: { flex: 1, textAlign: 'center', fontSize: 11, color: colors.faint, fontFamily: fonts.sansBold },
  ...
  dayFull: { backgroundColor: colors.primary },
  dayPartial: { backgroundColor: colors.petal },
  dayMissed: { backgroundColor: '#F4ECEF' },
  dayToday: { borderWidth: 2, borderColor: colors.deepRose },
  dayNum: { fontSize: 13, color: colors.ink, fontFamily: fonts.sans },
  dayNumLight: { color: '#FFF', fontFamily: fonts.sansBold },
  legend: { flexDirection: 'row', justifyContent: 'center', gap: 16, marginTop: 14 },
  legendItem: { flexDirection: 'row', alignItems: 'center', gap: 5 },
  legendDot: { width: 12, height: 12, borderRadius: 6 },
  legendText: { fontSize: 11, color: colors.muted, fontFamily: fonts.sans },
  adherenceCard: { backgroundColor: colors.accentSoft, borderRadius: radius.card, padding: 18, alignItems: 'center', marginTop: 20 },
  adherenceLabel: { fontSize: 12, color: colors.accentDeep, fontFamily: fonts.sansBold, letterSpacing: 0.4 },
  adherenceValue: { fontSize: 36, color: colors.accentDeep, fontFamily: fonts.serifBold, marginVertical: 2 },
  adherenceSub: { fontSize: 12, color: colors.deepRose, fontFamily: fonts.sans },
  note: { fontSize: 11, color: colors.faint, textAlign: 'center', marginTop: 16, lineHeight: 16, fontFamily: fonts.sans },
});