...
const styles = StyleSheet.create({
  ...
  catScroll: { marginTop: 12, maxHeight: 42 },
  catRow: { paddingHorizontal: 18, gap: 8 },
  cat: { paddingVertical: 9, paddingHorizontal: 14, borderRadius: 100, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.cardBorder, height: 36, justifyContent: 'center' },
